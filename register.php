            ...
            <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                <div class="flex-1 rounded-lg p-6" style="background-color: rgb(17 24 39 / 0.4);">
                    ...
                    <div class="mt-3">
                            ...
                            <div class="mt-6">
                                <button id="signupButton" onclick="SignUp()" disabled class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#8B78EA] rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                    Loading..
                                </button>
                            </div>
