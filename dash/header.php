...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/datatables.css?v=1690167653">

	<link rel="stylesheet" href="/nebulanuke/dash/assets/css/new_style.css"/>
	<link rel="icon" href="/nebulanuke/assets/favicon.ico" type="image/x-icon" />
	<style>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto sidebar-bg">
      ...
      <ul class="space-y-2 font-medium">
         <li>
            <a href="/nebulanuke/dash/home" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?=$pagename=='Dashboard' ? 'active' : '' ?>">
         ...
         <li>
            <a href="/nebulanuke/dash/stress" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?=$pagename=='Stress Panel' ? 'active' : '' ?>">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
         ...
         <li>
            <a href="/nebulanuke/dash/purchase" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?=$pagename=='Purchase' ? 'active' : '' ?>">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
		 ...
		 <li>
            <a href="/nebulanuke/dash/deposit" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?=$pagename=='Deposit' ? 'active' : '' ?>">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
	          ...
	          <div class="flex items-center ml-3">
	            ...
	            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1828px, 61px);" data-popper-placement="bottom">
	              ...
	              <ul class="py-1" role="none">
	                <li>
	                  <a href="/nebulanuke/dash/profile" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Profile</a>
	                </li>
					<?php if($isAdmin): ?>
						<li>
	                  		<a href="/nebulanuke/dash/admin/home" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Admin dashboard</a>
	                	</li>
					<?php endif; ?>
	                <li>
